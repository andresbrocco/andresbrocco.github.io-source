  ...
  return function e(t, n, r) {
    ...
    3: [function(require, module, exports) {
      ...
      GIF = function(superClass) {
        ...
        GIF.prototype.render = function(callback) {
          ...
          numWorkers = this.spawnWorkers(callback);
          if (this.options.globalPalette === true) {
            this.renderNextFrame(callback)
          } else {
        ...
        GIF.prototype.spawnWorkers = function(callback) {
          ...
          (function() {
            ...
            return function(i) {
              ...
              worker.onmessage = function(event) {
                ...
                return _this.frameFinished(event.data, callback)
              };
        ...
        GIF.prototype.frameFinished = function(frame, callback) {
          var i, j, ref;
          ...
          if (indexOf.call(this.imageParts, null) >= 0) {
            return this.renderNextFrame(callback)
          } else {
            return this.finishRendering(callback)
          }
        };
        ...
        GIF.prototype.renderNextFrame = function(callback) {
          ...
          callback((task.index + 1)/this.frames.length);
